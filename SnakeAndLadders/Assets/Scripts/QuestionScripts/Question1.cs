...
public class Question1 : MonoBehaviour
{
    ...
    IEnumerator closeQ()
    {
        ...
        if(main.getTurn == 1)
        {
            if(!isRight)
            {
                main.player1.transform.position = new Vector2(main.player1.transform.position.x - (40 *4), main.player1.transform.position.y);
                main.numP1 = 4;
            }
        ...
        else if(main.getTurn == 2)
        {
            if (!isRight)
            {
                main.player2.transform.position = new Vector2(main.player2.transform.position.x - (40 * 4), main.player2.transform.position.y);
                main.numP2 = 4;
            }
        }
